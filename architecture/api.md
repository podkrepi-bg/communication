...
До момента успяхме да изградим следната система от микросървиси, свързани с публичния сайт на Проекта.
...
![](<../.gitbook/assets/Technical landscape - Module Communication (Done) (1).jpg>)
